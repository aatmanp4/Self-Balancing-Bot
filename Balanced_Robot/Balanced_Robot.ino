// Aatman Patel - @aatmanp4 
// Self Balancing Bot 
// MPU Calibration MEMS
...
#define PID_PITCH_KI 100
#define PID_PITCH_KD 0.8

#define PID_YAW_KP 0.2
...
//OFFSETS    -2336,   -1817,     654,       2,      10,     -53
  mpu.setXAccelOffset(-2336);    
  mpu.setYAccelOffset(-1817); 
  mpu.setZAccelOffset(654);   
